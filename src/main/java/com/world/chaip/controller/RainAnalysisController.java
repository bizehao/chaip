...
public class RainAnalysisController {
    ...
    public JsonResult getRainAnalysisNZY(
        ...
        List<YearAndMonthRain> a = service.getRainNZYCompared(date, adcdlist, typelist,stcdlist);
        return new JsonResult(a);
    }
    ...
    public JsonResult getRainAnalysisRY(
        ...
        List<ArbitrarilyDay> a = service.getRainRYCompared(dateS, dateE, adcdlist, typelist,stcdlist);
        return new JsonResult(a);
    }
}
