...
public class ExportExecls {
	 ...
	 * 标题头单元格样式
	 */
	private HSSFCellStyle getTitleStyle(HSSFWorkbook workbook, CellRangeAddress addresses) {
		// 设置字体
	 ...
	 * 时间信息行单元格样式
	 */
	private HSSFCellStyle getTimeStyle(HSSFWorkbook workbook, CellRangeAddress addresses) {
		// 设置字体
		HSSFFont font = workbook.createFont();
		//设置字体名字
		font.setFontName("Courier New");
